var SevenSegmentDigit = function()
{
  ...
  function createStyle()
  {
    ...
    style.innerHTML = 'svg[data-digit] path{opacity:0.05}svg[data-digit="0"] path:not(.-g),svg[data-digit="1"] path.-b,svg[data-digit="1"] path.-c,svg[data-digit="2"] path.-a,svg[data-digit="2"] path.-b,svg[data-digit="2"] path.-d,svg[data-digit="2"] path.-e,svg[data-digit="2"] path.-g,svg[data-digit="3"] path.-a,svg[data-digit="3"] path.-b,svg[data-digit="3"] path.-c,svg[data-digit="3"] path.-d,svg[data-digit="3"] path.-g,svg[data-digit="4"] path.-b,svg[data-digit="4"] path.-c,svg[data-digit="4"] path.-f,svg[data-digit="4"] path.-g,svg[data-digit="5"] path.-a,svg[data-digit="5"] path.-c,svg[data-digit="5"] path.-d,svg[data-digit="5"] path.-f,svg[data-digit="5"] path.-g,svg[data-digit="6"] path:not(.-b),svg[data-digit="7"] path.-a,svg[data-digit="7"] path.-b,svg[data-digit="7"] path.-c,svg[data-digit="8"] path,svg[data-digit="9"] path:not(.-e){opacity:1}';
